...
const index = require('./index-d9c0586e.js');
...
const JeepPhotoButtons = class {
  constructor(hostRef) {
    ...
    this.onPhotoButtonsClose = index.createEvent(this, "jeepPhotoButtonsClose", 7);
    this.onPhotoRequestFullscreen = index.createEvent(this, "jeepPhotoRequestFullscreen", 7);
    this.onPhotoRequestMinimize = index.createEvent(this, "jeepPhotoRequestMinimize", 7);
    this.onPhotoButtonsShare = index.createEvent(this, "jeepPhotoButtonsShare", 7);
  ...
  render() {
    ...
    if (this.innerShare === "visible" &&
      this.innerFromComponent === "jeep-photo-hscroll") {
      toRender = [...toRender, index.h("div", { class: "share-button", onClick: () => this._handleClick("share") })
      ];
    }
    if (this.innerFromComponent === "jeep-photo-hscroll")
      toRender = [...toRender, index.h("div", { class: "mode-button", onClick: () => this._handleClick("mode") })
      ];
    if (this.innerCloseButton === "yes") {
      toRender = [...toRender, index.h("div", { class: "close-button", onClick: () => this._handleClick("close") })
      ];
    }
    return (index.h(index.Host, null, index.h("div", { class: "photobuttons-container" }, index.h("div", { class: "wrapper" }, toRender))));
  }
...
const JeepPhotoHscroll = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.onPhotoHscrollResult = index.createEvent(this, "jeepPhotoHscrollResult", 7);
    this.onPhotoZoom = index.createEvent(this, "jeepPhotoZoom", 7);
    this.onPhotoPhotoHscrollClose = index.createEvent(this, "jeepPhotoHscrollClose", 7);
    this._tapped = false;
  ...
  render() {
    ...
    if (this.innerImageList != null && this.innerImageList.length > 0) {
      ...
      if (this.innerMode === "gallery" || this.innerMode === "slider") {
        for (var i = 0; i < this.innerImageList.length; i++) {
          toRenderImg = [...toRenderImg, index.h("div", { class: "carousel-item", onClick: () => this._handleClick() }, index.h("img", { src: this.innerImageList[i].url, alt: this.innerImageList[i].title, class: "carousel-image" }), index.h("p", { class: classTitle }, this.innerImageList[i].title))
          ];
        }
      }
      if (this.innerMode === "one") {
        toRenderImg = [...toRenderImg, index.h("div", { class: "carousel-item", onClick: () => this._handleClick() }, index.h("img", { src: this.innerImageList[this.innerPosition].url, alt: this.innerImageList[this.innerPosition].title, class: "carousel-image" }), index.h("p", { class: classTitle }, this.innerImageList[this.innerPosition].title))
        ];
      }
    }
    ...
    if (this.buttonsVisibility) {
      ...
      toRender = [...toRender, index.h("jeep-photo-buttons", { share: this.share, viewmode: mode, closebutton: "yes", fromcomponent: "jeep-photo-hscroll" })
      ];
    }
    let toRenderShare = [];
    if (this.shareShow) {
      toRenderShare = [...toRenderShare, index.h("jeep-photo-share", { surl: this._shareUrl, stitle: this._shareTitle, stext: this._shareText })
      ];
    }
    return (index.h(index.Host, null, index.h("div", { class: "hscroll-container" }, index.h("div", { class: "wrapper" }, this.photoZoom
      ?
        index.h("jeep-photo-zoom", { url: this.innerImageList[this.currentIndex].url, maxzoomscale: this.maxZoomScale })
      :
        index.h("div", null, index.h("jeep-photo-swipe", null, index.h("div", { class: "carousel hidden" }, toRenderImg)), toRender, toRenderShare)))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const JeepPhotoShare = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.onPhotoShareCompleted = index.createEvent(this, "jeepPhotoShareCompleted", 7);
    this.surl = null;
    this.stitle = null;
    this.stext = null;
...
const JeepPhotoSwipe = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.onPhotoSwipe = index.createEvent(this, "jeepPhotoSwipe", 7);
    this._startPoint = {};
    this._endPoint = {};
    this._totalTime = 0;
  ...
  //*************************
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "swipe-container", onTouchStart: (e) => this.handleTouchStart(e), onTouchEnd: (e) => this.handleTouchEnd(e), onMouseDown: (e) => this.handleMouseDown(e), onMouseUp: (e) => this.handleMouseUp(e) }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const JeepPhotoZoom = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.onPhotoZoomOneTap = index.createEvent(this, "jeepPhotoZoomOneTap", 7);
  ...
  //*************************
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "zoom-container" }, index.h("div", { class: "wrapper" }, index.h("div", { class: "zoom-item" })))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "url": ["parseUrl"],
...
const JeepPhotoviewer = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.onPhotoViewerResult = index.createEvent(this, "jeepPhotoViewerResult", 7);
    //**********************************
  ...
  render() {
    ...
    if (this.innerImageList != null && this.innerImageList.length > 0) {
      for (var i = 0; i < this.innerImageList.length; i++) {
        ...
        if (this.innerMode === "gallery") {
          toRender = [...toRender, index.h("div", { class: "placeholder", style: placeHolderStyle }, index.h("div", { id: boxId, class: "image", onClick: () => this._handleClick(boxId), style: elStyle }, index.h("img", null)))
          ];
        }
        else {
          toRender = [...toRender, index.h("div", { class: "placeholder", style: placeHolderStyle }, index.h("div", { id: boxId, class: "image", style: elStyle }, index.h("img", null)))
          ];
        }
      }
    }
    return (index.h(index.Host, null, !this.close
      ?
        index.h("div", { class: "photoviewer-container" }, this.showHScroll
          ?
            index.h("jeep-photo-hscroll", { position: this._selPos, imageList: this.innerImageList, options: this.innerOptions, mode: this.innerMode })
          :
            index.h("div", { class: "wrapper" }, toRender, index.h("jeep-photo-buttons", { share: "false", viewmode: "normal", closebutton: "yes", fromcomponent: "jeep-photoviewer" })))
      :
        null));
  }
...
exports.jeep_photo_buttons = JeepPhotoButtons;
exports.jeep_photo_hscroll = JeepPhotoHscroll;
exports.jeep_photo_share = JeepPhotoShare;
exports.jeep_photo_swipe = JeepPhotoSwipe;
exports.jeep_photo_zoom = JeepPhotoZoom;
exports.jeep_photoviewer = JeepPhotoviewer;
