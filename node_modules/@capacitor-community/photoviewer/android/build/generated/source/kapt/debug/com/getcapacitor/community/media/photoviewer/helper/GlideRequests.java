...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.getcapacitor.community.media.photoviewer.helper.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.getcapacitor.community.media.photoviewer.helper.GlideOptions().apply(toSet));
    }
  }
}
